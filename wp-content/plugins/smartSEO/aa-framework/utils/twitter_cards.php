<?php
/*
* Define class psp_TwitterCards
* Make sure you skip down to the end of this file, as there are a few
* lines of code that are very important.
*/
!defined('ABSPATH') and exit;
if (class_exists('psp_TwitterCards') != true) {
	class psp_TwitterCards {
		...
		public function card_types() {
			...
			$twc['summary'] = array(
				...
				'fields'		=> array(
					'title'			=> array(
						...
						'meta'		=> 'twitter:title',
						'maxlen' 	=> 70,
						'title'		=>esc_html__('Title', 'smartSEO'),
						'desc'		=>esc_html__('Title should be concise and will be truncated at 70 characters.', 'smartSEO')
					),
					'description'		=> array(
						'type' 		=> 'textarea',
						'meta'		=> 'twitter:description',
						'maxlen' 	=> 200,
						'title'		=>esc_html__('Description', 'smartSEO'),
						'desc'		=>esc_html__('A description that concisely summarizes the content of the page, as appropriate for presentation within a Tweet. Do not re-use the title text as the description, or use this field to describe the general services provided by the website. Description text will be truncated at the word to 200 characters.', 'smartSEO')
					),
					'image'		=> array(
						'type'		=> 'upload_image',
						'meta'		=> 'twitter:image',
			...
			$twc['summary_large_image'] = array_replace_recursive($twc['summary'], array(
				...
				'fields'		=> array(
					...
					//	'filesize' 	=> '1048576', // bytes
					//	'title'		=>esc_html__('Image', 'smartSEO'),
					//	'desc'		=>esc_html__('URL to a unique image representing the content of the page. Do not use a generic image such as your website logo, author photo, or other image that spans multiple pages. Images for this Card should be at least 280px in width, and at least 150px in height. Image must be less than 1MB in size.', 'smartSEO')
					//)
					'image'		=> array(
						'minsize' 	=> '280x150', // width X height
						'filesize' 	=> '1048576', // bytes
			...
			$twc['photo'] = array_replace_recursive($twc['summary'], array(
				...
				'fields'		=> array(
					'title'			=> array(
						'desc'		=>esc_html__('The title of your content as it should appear in the card. You may specify an empty string if you wish no title to render.', 'smartSEO')
					),
					'image'		=> array(
						'meta'		=> 'twitter:image',
						'minsize' 	=> '280x150', // width X height
						...
						'desc'		=>esc_html__('A URL to the image representing the content. Image must be less than 1MB in size.', 'smartSEO')
					),
					'image_width'		=> array(
						'type'		=> 'text',
						'meta'		=> 'twitter:image:width',
						'title'		=>esc_html__('Image Width', 'smartSEO'),
						'desc'		=>esc_html__('Providing width in px helps us more accurately preserve the aspect ratio of the image when resizing.', 'smartSEO')
					),
					'image_height'	=> array(
						'type'		=> 'text',
						'meta'		=> 'twitter:image:height',
						'title'		=>esc_html__('Image Height', 'smartSEO'),
						'desc'		=>esc_html__('Providing height in px helps us more accurately preserve the aspect ratio of the image when resizing.', 'smartSEO')
					)
				)
			));
			...
			$twc['gallery'] = array_replace_recursive($twc['summary'], array(
				...
				'fields'		=> array(
					...
					'image0'		=> array(
						...
						'minsize' 	=> '120x120', // width X height
						'filesize' 	=> '1048576', // bytes
						'title'		=>esc_html__('Image 0', 'smartSEO'),
						'desc'		=>esc_html__('A URL to the image representing the first photo in your gallery. Image must be less than 1MB in size.', 'smartSEO')
					),
					'image1'		=> array(
						'type'		=> 'upload_image',
						'meta'		=> 'twitter:image1',
						'minsize' 	=> '120x120', // width X height
						'filesize' 	=> '1048576', // bytes
						'title'		=>esc_html__('Image 1', 'smartSEO'),
						'desc'		=>esc_html__('A URL to the image representing the first photo in your gallery. Image must be less than 1MB in size.', 'smartSEO')
					),
					'image2'		=> array(
						'type'		=> 'upload_image',
						...
						'minsize' 	=> '120x120', // width X height
						'filesize' 	=> '1048576', // bytes
						'title'		=>esc_html__('Image 2', 'smartSEO'),
						'desc'		=>esc_html__('A URL to the image representing the first photo in your gallery. Image must be less than 1MB in size.', 'smartSEO')
					),
					'image3'		=> array(
						'type'		=> 'upload_image',
						...
						'minsize' 	=> '120x120', // width X height
						'filesize' 	=> '1048576', // bytes
						'title'		=>esc_html__('Image 3', 'smartSEO'),
						'desc'		=>esc_html__('A URL to the image representing the first photo in your gallery. Image must be less than 1MB in size.', 'smartSEO')
					)
				)
			));
			...
			$twc['player'] = array_replace_recursive($twc['summary'], array(
				...
				'fields'		=> array(
					'image'		=> array(
						...
						'desc'		=>esc_html__('Image to be displayed in place of the player on platforms that don\'t support iframes or inline players. You should make this image the same dimensions as your player. Images with fewer than 68,600 pixels (a 262x262 square image, or a 350x196 16:9 image) will cause the player card not to render. Image must be less than 1MB in size.', 'smartSEO')
					),
					'player'		=> array(
						'type' 		=> 'text',
						'meta'		=> 'twitter:player',
						'title'		=>esc_html__('Player', 'smartSEO'),
						'desc'		=>esc_html__('HTTPS URL to iFrame player. This must be a HTTPS URL which does not generate active mixed content warnings in a web browser. The audio or video player must not require plugins such as Adobe Flash.', 'smartSEO')
					),
					'player_width'	=> array(
						'type' 		=> 'text',
						'meta'		=> 'twitter:player:width',
						'title'		=>esc_html__('Player width', 'smartSEO'),
						'desc'		=>esc_html__('Width of IFRAME specified in twitter:player in pixels', 'smartSEO')
					),
					'player_height'	=> array(
						'type' 		=> 'text',
						'meta'		=> 'twitter:player:height',
						'title'		=>esc_html__('Player height', 'smartSEO'),
						'desc'		=>esc_html__('Height of IFRAME specified in twitter:player in pixels', 'smartSEO')
					),
					'player_stream'	=> array(
						'type' 		=> 'text',
						'meta'		=> 'twitter:player:stream',
						'title'		=>esc_html__('Player stream', 'smartSEO'),
						'desc'		=>esc_html__('URL to raw stream that will be rendered
...
Audio: AAC, Low Complexity Profile (LC)', 'smartSEO')
					),
					'player_stream_content_type'	=> array(
						'type' 		=> 'text',
						'meta'		=> 'twitter:player:stream:content_type',
						'title'		=>esc_html__('Player stream content type', 'smartSEO'),
						'desc'		=>esc_html__('The MIME type/subtype combination that describes the content contained in twitter:player:stream. Takes the form specified in RFC 6381. Currently supported content_type values are those defined in RFC 4337 (MIME Type Registration for MP4).', 'smartSEO')
					)
				)
			));
			...
			$twc['product'] = array_replace_recursive($twc['summary'], array(
				...
				'fields'		=> array(
					...
					'image_width'	=> array(
						...
						'meta'		=> 'twitter:image:width',
						'title'		=>esc_html__('Image width', 'smartSEO'),
						'desc'		=>esc_html__('Providing width in px helps us more accurately preserve the the aspect ratio of the image when resizing.', 'smartSEO')
					),
					'image_height'	=> array(
						'type' 		=> 'text',
						'meta'		=> 'twitter:image:height',
						'title'		=>esc_html__('Image height', 'smartSEO'),
						'desc'		=>esc_html__('Providing height in px helps us more accurately preserve the the aspect ratio of the image when resizing.', 'smartSEO')
					),
					'data1'	=> array(
						'type' 		=> 'text',
						'meta'		=> 'twitter:data1',
						'title'		=>esc_html__('Data 1', 'smartSEO'),
						'desc'		=>esc_html__('This field expects a string, and you can specify values for labels such as price, items in stock, sizes, etc.', 'smartSEO')
					),
					'label1'	=> array(
						'type' 		=> 'text',
						'meta'		=> 'twitter:label1',
						'title'		=>esc_html__('Label 1', 'smartSEO'),
						'desc'		=>esc_html__('This field also expects a string, and allows you to specify the types of data you want to offer (price, country, etc.).', 'smartSEO')
					),
					'data2'	=> array(
						'type' 		=> 'text',
						'meta'		=> 'twitter:data2',
						'title'		=>esc_html__('Data 2', 'smartSEO'),
						'desc'		=>esc_html__('This field expects a string, and you can specify values for labels such as price, items in stock, sizes, etc.', 'smartSEO')
					),
					'label2'	=> array(
						'type' 		=> 'text',
						'meta'		=> 'twitter:label2',
						'title'		=>esc_html__('Label 2', 'smartSEO'),
						'desc'		=>esc_html__('This field also expects a string, and allows you to specify the types of data you want to offer (price, country, etc.).', 'smartSEO')
					)
				)
			));
			...
			$twc['app'] = array_replace_recursive($twc['summary'], array(
				...
				'fields'		=> array(
					'app_description'		=> array(
						...
						'maxlen' 	=> 200,
						'title'		=>esc_html__('Description', 'smartSEO'),
						'desc'		=>esc_html__('You can use this as a more concise description than what you may have on the app store. This field has a maximum of 200 characters.', 'smartSEO')
					),
					'app_name_iphone'	=> array(
						'type' 		=> 'text',
						'meta'		=> 'twitter:app:name:iphone',
						'title'		=>esc_html__('App Name Iphone', 'smartSEO'),
						'desc'		=>esc_html__('Your app\'s name.', 'smartSEO')
					),
					'app_name_ipad'	=> array(
						'type' 		=> 'text',
						'meta'		=> 'twitter:app:name:ipad',
						'title'		=>esc_html__('App Name Ipad', 'smartSEO'),
						'desc'		=>esc_html__('Your app\'s name.', 'smartSEO')
					),
					'app_name_googleplay'	=> array(
						'type' 		=> 'text',
						'meta'		=> 'twitter:app:name:googleplay',
						'title'		=>esc_html__('App Name Googleplay', 'smartSEO'),
						'desc'		=>esc_html__('Your app\'s name.', 'smartSEO')
					),
					'app_id_iphone'	=> array(
						'type' 		=> 'text',
						'meta'		=> 'twitter:app:id:iphone',
						'title'		=>esc_html__('App Id Iphone', 'smartSEO'),
						'desc'		=>esc_html__('String value, and should be the numeric representation of your app ID in the App Store (.i.e. "307234931")..', 'smartSEO')
					),
					'app_id_ipad'	=> array(
						'type' 		=> 'text',
						'meta'		=> 'twitter:app:id:ipad',
						'title'		=>esc_html__('App Id Ipad', 'smartSEO'),
						'desc'		=>esc_html__('String value, should be the numeric representation of your app ID in the App Store (.i.e. "307234931").	.', 'smartSEO')
					),
					'app_id_googleplay'	=> array(
						'type' 		=> 'text',
						'meta'		=> 'twitter:app:id:googleplay',
						'title'		=>esc_html__('App Id Googleplay', 'smartSEO'),
						'desc'		=>esc_html__('String value, and should be the numeric representation of your app ID in Google Play (.i.e. "com.android.app").', 'smartSEO')
					),
					'app_url_iphone'	=> array(
						'type' 		=> 'text',
						'meta'		=> 'twitter:app:url:iphone',
						'title'		=>esc_html__('App Url Iphone', 'smartSEO'),
						'desc'		=>esc_html__('Your app\'s custom URL scheme (you must include "://" after your scheme name).', 'smartSEO')
					),
					'app_url_ipad'	=> array(
						'type' 		=> 'text',
						'meta'		=> 'twitter:app:url:ipad',
						'title'		=>esc_html__('App Url Ipad', 'smartSEO'),
						'desc'		=>esc_html__('Your app\'s custom URL scheme.', 'smartSEO')
					),
					'app_url_googleplay'	=> array(
						'type' 		=> 'text',
						'meta'		=> 'twitter:app:url:googleplay',
						'title'		=>esc_html__('App Url Googleplay', 'smartSEO'),
						'desc'		=>esc_html__('Your app\'s custom URL scheme.', 'smartSEO')
					),
					'app_country'	=> array(
						'type' 		=> 'text',
						'meta'		=> 'twitter:app:country',
						'title'		=>esc_html__('Country', 'smartSEO'),
						'desc'		=>esc_html__('If your application is not available in the US App Store, you must set this value to the two-letter country code for the App Store that contains your application.', 'smartSEO')
					)
				)
			));
		...
		public function set_options( $defaults = array(), $pms = array() ) {
			...
			foreach ($currentCardFields as $k => $v) {
				...
				if ( $v['type'] == 'upload_image' ) {
					$__imgSize = array(0, 0);
					if ( isset($v['minsize']) ) {
						$__imgSize = explode('x', (string) $v['minsize'][0]);
					}

					$__options["$key"] = array_merge($__options["$key"], array(
						'value' 	=>esc_html__('Upload image', 'smartSEO'),
						'thumbSize' 	=> array(
			...
			$options = array(
				array(
					...
					$boxId => array(
						'title' 	=> '<div style="position:relative;">' . sprintf(esc_html__('%s Twitter Card Options', 'smartSEO'), $boxTitle ) . '<div style="position:absolute; top:0; right:0;"><a href="' . $currentCard['dev_url'] . '" target="_blank">' .esc_html__('Twitter Cards: ', 'smartSEO') . $currentCard['title'] . '</a></div></div>',
		...
		public function save_meta( $pms = array()) {
			...
			$card_type = isset($_REQUEST['psp_twc_post_cardtype'])
				? strtolower(sanitize_text_field($_REQUEST['psp_twc_post_cardtype'])) : 'none';
			$app_card_type = isset($_REQUEST['psp_twc_app_isactive'])
				? strtolower(sanitize_text_field($_REQUEST['psp_twc_app_isactive'])) : 'no';
			$thumbsize = isset($_REQUEST['psp_twc_post_thumbsize'])
				? sanitize_text_field($_REQUEST['psp_twc_post_thumbsize']) : 'none';
			...
			foreach ($post_cardtypes as $kk=>$vv) {
				...
				foreach ($currentCardFields as $k => $v) {
					...
					$key = self::$prefixFields . $k;
					$__options["$key"] = trim( sanitize_text_field($_REQUEST["$key"]) );
				}
			}
			return $__options;
		}
...
// Initialize the psp_TwitterCards class
//$psp_TwitterCards = new psp_TwitterCards();
