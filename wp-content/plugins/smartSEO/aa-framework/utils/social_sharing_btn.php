<?php
/*
* Define class psp_SocialSharingButtons
* Make sure you skip down to the end of this file, as there are a few
* lines of code that are very important.
*/
!defined('ABSPATH') and exit;
if (class_exists('psp_SocialSharingButtons') != true) {
	class psp_SocialSharingButtons {
		...
		*/
		...
		private function buildButtonUrl( $netUrl, $network = '') {
			...
			switch ($network) {
				...
				case 'stumbleupon':
					...
					$width = '70';
					$height = '22';
					if ( $this->btnViewCount == 'yes' && $this->btnSize == 'large' ) {
						$count = '5';
						$height = '80'; } else if ( $this->btnViewCount == 'yes' ) {
						$count = '1'; } else if ( $this->btnSize == 'large' ) {
							$count = '6';
							$height = '40'; }
		...
		public function print_btn() {
			$text = $this->get_property( 'text_print', 'string' );
		...
		public function email_btn() {
			$text = $this->get_property( 'text_email', 'string' );
		...
		public function more_btn( $btnList = array() ) {
			$text = $this->get_property( 'text_more', 'string' );
...
// Initialize the psp_SocialSharingButtons class
//$psp_SocialSharingButtons = new psp_SocialSharingButtons();
