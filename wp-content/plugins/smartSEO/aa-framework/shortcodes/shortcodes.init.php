...
if (class_exists('psp_aafShortcodes') != true) {
	class psp_aafShortcodes {
		...
		*/
		...
		public function admin_init() {
			...
			$localize['plugin_btn_title'] =esc_html__('Premium SEO Pack Shortcodes', 'smartSEO');
