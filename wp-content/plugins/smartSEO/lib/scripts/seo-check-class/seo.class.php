 ...
 * ======================
 *
 * @package			psp_SeoCheck
 * @author			AA-Team
 */
if ( !class_exists('psp_SeoCheck') ) {
	class psp_SeoCheck {
		 ...
		 * Singleton pattern
		 *
		 * @return psp_SeoCheck Singleton instance
		 */
		...
		public function set_current_post( $p = 0, $post_content = 'empty' ) {
			...
			if ( $post_id == 0 ) {
				die(esc_html__('Invalid Post ID', 'smartSEO') );
			}
		...
		public function score_seo_title( $str, $focus_kw ) {
			...
			$msgs = array(
			'missing' 			=> esc_html__('Bad, please create a SEO title.', 'smartSEO' ),
			'missing_focus_kw'	=> esc_html__('Bad, you have a SEO title, but you must create a focus keyword.', 'smartSEO' ),
			'less_characters' 	=> esc_html__('Bad, the SEO title contains %1$d characters, which is less than the recommended minimum of %2$d characters.', 'smartSEO' ),
			'more_characters' 	=> esc_html__('Bad, the SEO title contains %1$d characters, which is more than the viewable limit of %2$d characters.', 'smartSEO' ),
			'no_focus_kw' 		=> esc_html__('Bad, the focus keyword <strong>%s</strong> does not appear in the SEO title.', 'smartSEO' ),
			'poor' 				=> esc_html__('Poor, the SEO title contains between %1\$d and %2\$d characters and contains your focus keyword, but it doesn\'t begin with it.', 'smartSEO' ),
			'good' 				=> esc_html__('Great, the SEO title contains between %1$d and %2$d characters and also it begins with your focus keyword.', 'smartSEO' )
			);
		...
		public function score_seo_title_enough_words( $page_content, $min_words = 3 ) {
			...
			$msgs = array(
			'missing' 			=> esc_html__('Enough words - Bad, please create a SEO title.', 'smartSEO' ),
			'less_words' 		=> esc_html__('Bad, the SEO title contains %1$d allowed words, which is less than the recommended minimum of %2$d words.', 'smartSEO' ),
			'good' 				=> esc_html__('Great, the SEO title contains %1$d allowed words and the recommended minimum is %2$d words.', 'smartSEO' )
			);
		...
		public function score_page_title( $str, $focus_kw ) {
			...
			$msgs = array(
			'missing' 			=> esc_html__('Bad, please create a page title.', 'smartSEO' ),
			'missing_focus_kw'	=> esc_html__('Bad, you have a page title, but you must create a focus keyword.', 'smartSEO' ),

			'bad' 				=> esc_html__('Bad, the page title contains %1\$d characters and it\'s not between %2\$d and %3\$d characters, which is the recommended interval.', 'smartSEO' ),
			'poor' 				=> esc_html__('Poor, the page title contains %1\$d characters and it\'s not between %2\$d and %3\$d characters, which is the recommended interval.', 'smartSEO' ),
			'good'				=> esc_html__('Great, the page title contains %1\$d characters and it\'s between %2\$d and %3\$d characters, which is the recommended interval.', 'smartSEO' ),

			'no_focus_kw' 		=> esc_html__('Bad, the focus keyword <strong>%s</strong> does not appear in the page title.', 'smartSEO' ),
			'focus_kw_poor'		=> esc_html__('Poor, the page title contains your focus keyword, but it doesn\'t begin with it.', 'smartSEO' ),
			'focus_kw_good'		=> esc_html__('Great, the page title begins with your focus keyword.', 'smartSEO' )
			);
		...
		public function score_meta_description( $str, $focus_kw ) {
			...
			$msgs = array(
			'missing' 			=> esc_html__('Bad, please create a page meta description.', 'smartSEO' ),
			'missing_focus_kw'	=> esc_html__('Bad, you have a page meta description, but you must create a focus keyword.', 'smartSEO' ),
			'less_characters' 	=> esc_html__('Bad, the page meta description contains %1$d characters, which is less than the recommended minimum of %2$d characters.', 'smartSEO' ),
			'more_characters' 	=> esc_html__('Bad, the page meta description contains %1$d characters, which is more than the viewable limit of %2$d characters.', 'smartSEO' ),
			'no_focus_kw' 		=> esc_html__('Bad, the focus keyword <strong>%s</strong> does not appear in the page meta description.', 'smartSEO' ),
			'poor' 				=> esc_html__('Poor, the meta description contains between %1\$d and %2\$d characters and contains your focus keyword, but it doesn\'t begin with it.', 'smartSEO' ),
			'good' 				=> esc_html__('Great, the meta description contains between %1$d and %2$d characters and also it begins with your focus keyword.', 'smartSEO' )
			);
		...
		public function score_meta_keywords( $str, $focus_kw ) {
			...
			$msgs = array(
			'missing' 			=> esc_html__('Bad, please create the page meta keywords.', 'smartSEO' ),
			'missing_focus_kw'	=> esc_html__('Bad, you have the page meta keywords, but you must create a focus keyword.', 'smartSEO' ),
			'no_focus_kw' 		=> esc_html__('Bad, the focus keyword <strong>%s</strong> does not appear in the page meta keywords.', 'smartSEO' ),
			'good' 				=> esc_html__('Great, the page meta keywords contains your focus keyword.', 'smartSEO' )
			);
		...
		public function score_permalink( $str, $focus_kw ) {
			...
			$msgs = array(
			'missing' 			=> esc_html__('Bad, please create a page permalink.', 'smartSEO' ),
			'missing_focus_kw'	=> esc_html__('Bad, you have a page permalink, but you must create a focus keyword.', 'smartSEO' ),
			'no_focus_kw' 		=> esc_html__('Bad, the focus keyword <strong>%s</strong> does not appear in the page permalink.', 'smartSEO' ),
			'good' 				=> esc_html__('Great, the page permalink contains your focus keyword.', 'smartSEO' )
			);
		...
		public function score_first_paragraph( $str, $focus_kw ) {
			...
			$msgs = array(
			'missing' 			=> esc_html__('Bad, please create at least one paragraph in the page content.', 'smartSEO' ),
			'missing_focus_kw'	=> esc_html__('Bad, you have at least one paragraph in the page content, but you must create a focus keyword.', 'smartSEO' ),
			'no_focus_kw' 		=> esc_html__('Bad, the focus keyword <strong>%s</strong> does not appear in the page content first paragraph.', 'smartSEO' ),
			'good' 				=> esc_html__('Great, the page content first paragraph contains your focus keyword.', 'smartSEO' )
			);
		...
		public function score_embedded_content( $page_content ) {
			...
			$msgs = array(
			'missing' 			=> esc_html__('Embedded content - Bad, please add some content for your web page.', 'smartSEO' ),
			'frame_detect' 		=> esc_html__('Bad, frames can cause problems on your web page because search engines will not crawl or index the content within them.', 'smartSEO' ),
			'iframe_detect' 	=> esc_html__('Bad, iframes can cause problems on your web page because search engines will not crawl or index the content within them.', 'smartSEO' ),
			'flash_detect' 		=> esc_html__('Bad, flash can cause problems on your web page because search engines will not crawl or index the content within them.', 'smartSEO' ),
			'video_detect' 		=> esc_html__('Bad, video can cause problems on your web page because search engines will not crawl or index the content within them.', 'smartSEO' ),
			'good' 				=> esc_html__('Great, your web page content don\'t have any embedded content <i>(frame, iframe, object, embed or HTML5 video)</i>.', 'smartSEO' )
			);
		...
		public function score_enough_words( $page_content, $min_words = 250 ) {
			...
			$msgs = array(
			'missing' 			=> esc_html__('Enough words - Bad, please add some content for the page.', 'smartSEO' ),
			'less_words' 		=> esc_html__('Bad, the page content contains %1$d allowed words, which is less than the recommended minimum of %2$d words.', 'smartSEO' ),
			'good' 				=> esc_html__('Great, the page content contains %1$d allowed words and the recommended minimum is %2$d words.', 'smartSEO' )
			);
		...
		public function score_images_alt( $page_content, $focus_kw ) {
			...
			$msgs = array(
			'missing' 			=> esc_html__('Bad, the page content has no images.', 'smartSEO' ),
			'missing_focus_kw' 	=> esc_html__('Bad, the page content has %1$d images, but %2$d images contains your focus keyword in alt attribute.', 'smartSEO' ),
			'poor' 				=> esc_html__('Poor, the page content has %1$d images and %2$d images contains an alt attribute.', 'smartSEO' ),
			'good' 				=> esc_html__('Great, the page content has %1$d images and %2$d images contains your focus keyword in alt attribute.', 'smartSEO' )
			);
		...
		public function score_html_bold( $page_content, $focus_kw ) {
			...
			$msgs = array(
			'missing' 				=> esc_html__('Bad, the page content has no bold elements.', 'smartSEO' ),
			'less' 					=> esc_html__('Bad, the page content has %d bold elements, but none of them contains your focus keyword.', 'smartSEO' ),
			'good' 					=> esc_html__('Great, the page content has %d bold elements and at least 1 of them contains your focus keyword.', 'smartSEO' )
			);
		...
		public function score_html_italic( $page_content, $focus_kw ) {
			...
			$msgs = array(
			'missing' 			=> esc_html__('Bad, the page content has no italic elements.', 'smartSEO' ),
			'less' 				=> esc_html__('Bad, the page content has %d italic elements and none of them contains your focus keyword.', 'smartSEO' ),
			'good' 				=> esc_html__('Great, the page content has %d italic elements and at least 1 of them contains your focus keyword.', 'smartSEO' )
			);
		...
		public function score_html_underline( $page_content, $focus_kw ) {
			...
			$msgs = array(
			'missing' 			=> esc_html__('Bad, the page content has no underlined elements.', 'smartSEO' ),
			'less' 				=> esc_html__('Bad, the page content has %d underlined elements and none of them contains your focus keyword.', 'smartSEO' ),
			'good' 				=> esc_html__('Great, the page content has %d underlined elements and at least 1 of them contains your focus keyword.', 'smartSEO' )
			);
		...
		public function score_subheadings( $page_content, $focus_kw ) {
			...
			$msgs = array(
			'missing' 			=> esc_html__('Bad, the page content has no subheading tags (h1, h2, h3).', 'smartSEO' ),
			'missing_focus_kw' 	=> esc_html__('Bad, the page content has %1$d &lt;h1&gt;, %2$d &lt;h2&gt;, %3$d &lt;h3&gt; subheading tags and %4$d &lt;h1&gt;, %5$d &lt;h2&gt;, %6$d &lt;h3&gt; subheading tags contains your focus keyword.', 'smartSEO' ),
			'poor' 				=> esc_html__('Poor, the page content has %1$d &lt;h1&gt;, %2$d &lt;h2&gt;, %3$d &lt;h3&gt; subheading tags and %4$d &lt;h1&gt;, %5$d &lt;h2&gt;, %6$d &lt;h3&gt; subheading tags contains your focus keyword.', 'smartSEO' ),
			'ok' 				=> esc_html__('Ok, the page content has %1$d &lt;h1&gt;, %2$d &lt;h2&gt;, %3$d &lt;h3&gt; subheading tags and %4$d &lt;h1&gt;, %5$d &lt;h2&gt;, %6$d &lt;h3&gt; subheading tags contains your focus keyword.', 'smartSEO' ),
			'good' 				=> esc_html__('Great, the page content has %1$d &lt;h1&gt;, %2$d &lt;h2&gt;, %3$d &lt;h3&gt; subheading tags and %4$d &lt;h1&gt;, %5$d &lt;h2&gt;, %6$d &lt;h3&gt; subheading tags contains your focus keyword. Also your focus keyword appears at the begining in the &lt;h1&gt; tag.', 'smartSEO' )
			);
		...
		public function score_first100words( $page_content, $focus_kw, $words_limit = 100 ) {
			...
			$msgs = array(
			'missing' 			=> esc_html__('First 100 words - Bad, please add some content for the page.', 'smartSEO' ),
			'less_words' 		=> esc_html__('Bad, the page content doesn\'t contains your focus keyword in the first 100 words.', 'smartSEO' ),
			'good' 				=> esc_html__('Great, the page content contains your focus keyword in the first 100 words ( the number of focus keyword occurences is %d ).', 'smartSEO' )
			);
		...
		public function score_last100words( $page_content, $focus_kw, $words_limit = 100 ) {
			...
			$msgs = array(
			'missing' 			=> esc_html__('Last 100 words - Bad, please add some content for the page.', 'smartSEO' ),
			'less_words' 		=> esc_html__('Bad, the page content doesn\'t contains your focus keyword in the last 100 words.', 'smartSEO' ),
			'good' 				=> esc_html__('Great, the page content contains your focus keyword in the last 100 words ( the number of focus keyword occurences is %d ).', 'smartSEO' )
			);
		...
		public function score_links_external( $page_content, $focus_kw, $permalink ) {
			...
			$msgs = array(
			'missing' 			=> esc_html__('Bad, the page content has no external links.', 'smartSEO' ),
			'bad' 				=> esc_html__('Bad, the page content has %1$d external dofollow links and %2$d external nofollow links.', 'smartSEO' ),
			'poor'				=> esc_html__('Poor, the page content has %1$d external dofollow links and %2$d external nofollow links.', 'smartSEO' ),
			'good' 				=> esc_html__('Great, the page content has %d external links and none of them are nofollow.', 'smartSEO' )
			);
		...
		public function score_links_internal( $page_content, $focus_kw, $permalink ) {
			...
			$msgs = array(
			'missing' 			=> esc_html__('Bad, the page content has no internal links.', 'smartSEO' ),
			'bad' 				=> esc_html__('Bad, the page content has %1$d internal dofollow links and %2$d internal nofollow links.', 'smartSEO' ),
			'poor'				=> esc_html__('Poor, the page content has %1$d internal dofollow links and %2$d internal nofollow links.', 'smartSEO' ),
			'good' 				=> esc_html__('Great, the page content has %d internal links and none of them are nofollow.', 'smartSEO' )
			);
		...
		public function score_links_competing( $page_content, $focus_kw, $permalink ) {
			...
			$msgs = array(
			'missing' 			=> esc_html__('Competing Links - the page content has no links.', 'smartSEO' ),
			'bad' 				=> esc_html__('Bad, the page content has %1\$d potential competing links (which contains your focus keyword): <ul class=\'psp-competing-links\'><li>%2\$s</li></ul>', 'smartSEO' ),
			'great'				=> esc_html__('Great, the page content doesn\'t have any potential competing links (which contains your focus keyword).', 'smartSEO' )
			);
		...
		public function score_keyword_density( $density_arr = array() ) {
			...
			$msgs = array(
			'missing' 			=> esc_html__('Keyword density - Bad, please add some content for the page.', 'smartSEO' ),
			'missing_kw' 		=> esc_html__('Bad, keyword density is 0%%, because the focus keyword <strong>%s</strong> does not appear in the page content.', 'smartSEO' ),
			'bad' 				=> esc_html__('Bad, keyword density is %1\$.1f%% and it\'s not between %2\$.1f%% and %3\$.1f%%, which is the recommended interval. Your page content has %4\$d allowed words and the number of focus keyword occurences in the content is %5\$d.', 'smartSEO' ),
			'poor' 				=> esc_html__('Poor, keyword density is %1\$.1f%% and it\'s not between %2\$.1f%% and %3\$.1f%%, which is the recommended interval. Your page content has %4\$d allowed words and the number of focus keyword occurences in the content is %5\$d.', 'smartSEO' ),
			'good'				=> esc_html__('Great, keyword density is %1\$.1f%% and it\'s between %2\$.1f%% and %3\$.1f%%, which is the recommended interval. Your page content has %4\$d allowed words and the number of focus keyword occurences in the content is %5\$d.', 'smartSEO' ),

			'__needed'			=> esc_html__('You need between %1$d and %2$d focus keyword occurences in the page content to be situated in the recommended interval.', 'smartSEO' ),
			);
