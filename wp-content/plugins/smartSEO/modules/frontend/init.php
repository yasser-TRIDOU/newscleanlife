<?php
/*
* Define class psp_Frontend
* Make sure you skip down to the end of this file, as there are a few
* lines of code that are very important.
*/
!defined('ABSPATH') and exit;
if (class_exists('psp_Frontend') != true) {
	class psp_Frontend {
		...
		*/
		...
		public function do_virtual_robots() {
			...
			if ( $option === false || !isset($option['notify_virtual_robots']) ) {
				return false;
			}
...
//$psp_Frontend = new psp_Frontend();
$psp_Frontend = psp_Frontend::getInstance();
