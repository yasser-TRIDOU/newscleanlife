<?php
/*
* Define class psp_Dashboard
* Make sure you skip down to the end of this file, as there are a few
* lines of code that are very important.
*/
!defined('ABSPATH') and exit;
if (class_exists('psp_Dashboard') != true) {
	class psp_Dashboard {
		...
		*/
		public function __construct() {
			...
			if ( $this->the_plugin->is_admin === true ) {
				...
				new psp_DashboardAjax( $this->the_plugin );
			}
		...
		* Singleton pattern
		*
		* @return psp_Dashboard Singleton instance
		*/
		...
		public function plugin_dashboard_msg() {
			...
			$html[] = '<div class="panel-body ' . ( $this->the_plugin->alias ) . '-panel-body ' . ( $this->the_plugin->alias ) . '-no-padding" >
						<a href="http://docs.aa-team.com/smartseo" target="_blank" class="' . ( $this->the_plugin->alias ) . '-tab"><span class="psp-icon-support"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></span> Documentation</a>
		...
		public function links() {
			...
			foreach ($this->the_plugin->cfg['modules'] as $key => $value) {
				...
				if ( !in_array( $key, array_keys($this->the_plugin->cfg['activate_modules'])) ) {
					continue;
				}
...
// Initialize the psp_Dashboard class
$psp_Dashboard = new psp_Dashboard();
