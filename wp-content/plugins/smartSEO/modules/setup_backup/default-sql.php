<?php
/*
* Define class psp_SetupBackup
* Make sure you skip down to the end of this file, as there are a few
* lines of code that are very important.
*/
!defined('ABSPATH') and exit;
if (class_exists('psp_SetupBackup') != true) {
	class psp_SetupBackup {
...
// Initialize the psp_SetupBackup class
$psp_SetupBackup = psp_SetupBackup::getInstance();
