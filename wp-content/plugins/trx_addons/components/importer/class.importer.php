...
class trx_addons_demo_data_importer {
	...
	var $options = array(
		...
		'regenerate_thumbnails' => 0,							// Set number of thumbnails to regenerate when its imported
			...
			?><div class="trx_importer_section">
				...
				<form id="trx_importer_form">
					...
					<div class="trx_importer_demo_set">
						...
						<label><input type="radio"<?php if ($this->options['demo_set']=='full') echo ' checked="checked"'; ?> value="full" name="demo_set" /><?php esc_html_e('Whole demo-site content', 'trx_addons'); ?></label><?php esc_html_e('ALL EXISTING CONTENTS of your website will be deleted and replaced with the new data!', 'trx_addons'); ?>
	...
	function exporter() {
		...
		// Remove elegro Crypto Payment options
