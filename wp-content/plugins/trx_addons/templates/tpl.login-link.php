...
if ( !is_user_logged_in() ) {
	?><ul class="sc_layouts_login_menu sc_layouts_menu_nav"><li class="menu-item"><a href="#trx_addons_login_popup" class="trx_addons_popup_link trx_addons_login_link "><?php
...
// Else if user logged in
	...
	?><ul class="sc_layouts_login_menu sc_layouts_dropdown sc_layouts_menu_nav">
			...
			if (!empty($args['user_menu'])) {
				?><ul><?php
					...
					if (current_user_can('publish_posts')) {
						?><li class="menu-item trx_addons_icon-wpforms"><a href="<?php echo esc_url(home_url('/')); ?>/wp-admin/post-new.php?post_type=post"><span><?php esc_html_e('New post', 'trx_addons'); ?></span></a></li><?php
						// Delimiter
