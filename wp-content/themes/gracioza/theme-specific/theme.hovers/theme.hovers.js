...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
	...
	if (GRACIOZA_STORAGE['button_hover'] && GRACIOZA_STORAGE['button_hover']!='default') {
		jQuery('button:not(.search_submit):not([class*="sc_button_hover_"]),\
				...
				.gracioza_tabs .gracioza_tabs_titles li a:not([class*="sc_button_hover_"]),\
				...
				').addClass('sc_button_hover_just_init sc_button_hover_'+GRACIOZA_STORAGE['button_hover']);
		if (GRACIOZA_STORAGE['button_hover']!='arrow') {
		...
		jQuery('.sidebar .trx_addons_tabs .trx_addons_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
				.gracioza_tabs .gracioza_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
		...
		jQuery('.mejs-controls button,\
				...
				').removeClass('sc_button_hover_'+GRACIOZA_STORAGE['button_hover']);
