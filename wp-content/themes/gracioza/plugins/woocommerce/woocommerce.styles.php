...
if ( !function_exists( 'gracioza_woocommerce_get_css' ) ) {
	add_filter( 'gracioza_filter_get_css', 'gracioza_woocommerce_get_css', 10, 4 );
	function gracioza_woocommerce_get_css($css, $colors, $fonts, $scheme='') {
...
.single-product ul.products li.product .post_data .add_to_cart_button:before {
    background-color: {$colors['bg_color']}!important;
}
.single-product ul.products li.product .post_data .add_to_cart_button:after {
    border-left-color: {$colors['bg_color']}!important;
}
.single-product ul.products li.product .post_data .add_to_cart_button:hover {
    color: {$colors['text_hover']}!important;
}
.single-product ul.products li.product .post_data .add_to_cart_button:hover:before {
    background-color: {$colors['text_hover']}!important;
}
.single-product ul.products li.product .post_data .add_to_cart_button:hover:after {
    border-left-color: {$colors['text_hover']}!important;
}
...
/* Shop mode selector */
.gracioza_shop_mode_buttons a {
	color: {$colors['text_link']};
}
.gracioza_shop_mode_buttons a:hover {
	color: {$colors['text_hover']};
}
.shop_mode_thumbs .gracioza_shop_mode_buttons a.woocommerce_thumbs,
...
.woocommerce ul.products li.product .post_data .button:before,
.woocommerce-page ul.products li.product .post_data .button:before {
    background-color: {$colors['text_dark']};
}
.woocommerce div.product form.cart .button:after,
.woocommerce ul.products li.product .post_data .button:after,
.woocommerce-page ul.products li.product .post_data .button:after {
    border-left-color: {$colors['text_dark']};
}
.woocommerce div.product form.cart .button:hover,
.woocommerce ul.products li.product .post_data .button:hover,
.woocommerce-page ul.products li.product .post_data .button:hover {
    color: {$colors['text_hover']};
}
.woocommerce div.product form.cart .button:hover:before,
.woocommerce ul.products li.product .post_data .button:hover:before,
.woocommerce-page ul.products li.product .post_data .abutton:hover:before {
    background-color: {$colors['text_hover']};
}
.woocommerce div.product form.cart .button:hover:after,
.woocommerce ul.products li.product .post_data .button:hover:after,
.woocommerce-page ul.products li.product .post_data .button:hover:after {
