...
if (!function_exists('gracioza_trx_addons_get_css')) {
	add_filter('gracioza_filter_get_css', 'gracioza_trx_addons_get_css', 10, 4);
	function gracioza_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
ul.trx_addons_list_custom[class*="trx_addons_list"] li + li {
	border-color: {$colors['bd_color']};
}
.trx_addons_list_parameters > li + li {
	border-color: {$colors['bd_color']};
}
.sc_content[class*="vc_custom_"] ul[class*="trx_addons_list"],
.sc_content[class*="vc_custom_"] ul[class*="trx_addons_list"] > li:before {
	color: {$colors['bg_color']};
}
.sc_content[class*="vc_custom_"] ul[class*="trx_addons_list"] > li + li {
...
.sc_countdown_default.sc_countdown[class*="vc_custom_"] .sc_countdown_digits span {
	color: {$colors['bg_color']};
	border-color: {$colors['bg_color_0']};
	background-color: {$colors['bg_color_0']};
}
.sc_countdown_default.sc_countdown[class*="vc_custom_"] .sc_countdown_separator {
...
.sc_countdown[class*="vc_custom_"] .sc_countdown_label {
    color: {$colors['bg_color']};
}
...
.sc_price_item {
	color: {$colors['text']};
	background-color: {$colors['bg_color_025']};
	border-color: {$colors['bg_color_025']};
}
.sc_price_item:hover {
	background-color: {$colors['bg_color_025']};
	border-color: {$colors['bg_color_025']};
}
.sc_price_columns_wrap > [class*="trx_addons_column-"] .sc_price_item_title:before {
	color: {$colors['alter_link']};
	background-color: {$colors['bg_color']};
}
...
.scheme_default.footer_wrap .scheme_dark .socials_wrap .social_item .social_icon {
	color: {$colors['inverse_link']};
	background-color: {$colors['alter_link2']};
}
.scheme_default.footer_wrap .scheme_dark .socials_wrap .social_item:hover .social_icon {
	color: {$colors['inverse_hover']};
	background-color: {$colors['text_hover']};
}
...
.scheme_self.sc_googlemap_content .socials_wrap .social_item .social_icon {
	color: {$colors['inverse_link']};
	background-color: {$colors['alter_link']};
}
.scheme_self.sc_googlemap_content .socials_wrap .social_item:hover .social_icon {
	color: {$colors['inverse_hover']};
	background-color: {$colors['text_hover']};
}
...
.sc_testimonials_item_author_age {
...
.widget_area .post_item .post_info .post_info_date:hover {
    color: {$colors['text_dark']};
}
aside .post_item + .post_item {
	border-color: {$colors['bd_color']};
}
.sc_layouts_menu_nav > li li > a > span:before {
    background-color: {$colors['text_hover']};
}
.breadcrumbs .breadcrumbs_delimiter:before {
    border-left-color: {$colors['text_light']};
}

.widget_contacts .contacts_label {
    color: {$colors['text_dark']};
}
.widget_contacts .contacts_info span:not(.contacts_label),
.widget_contacts .contacts_info span:not(.contacts_label) > a,
.widget_contacts .contacts_info > div > a,
.widget_contacts .contacts_info > a {
    color: {$colors['text']};
}
...
.sc_action.color_style_link2 .sc_action_item .sc_action_item_subtitle > span,
...
.sc_action.color_style_link2.sc_action_default .sc_action_item_link:before,
.scheme_dark .sc_action.color_style_link2.sc_action_default .sc_action_item_link:before {
    background-color: {$colors['extra_bg_color']};
}
.sc_action.color_style_link2.sc_action_default .sc_action_item_link:after,
...
.sc_services_callouts .sc_services_item_title a {
    color: {$colors['text_link2']};
}
.sc_services_callouts.color_style_dark .sc_services_item_title a {
    color: {$colors['bg_color']};
}
.sc_services_callouts .sc_services_item_title a:hover {
    color: {$colors['text_link']};
}
.sc_services_callouts.color_style_dark .sc_services_item_title a:hover {
    color: {$colors['text_link']};
}
.sc_services_callouts.color_style_dark .sc_button_simple:not(.sc_button_bg_image) {
    color: {$colors['text_hover']};
}
.sc_services_callouts.color_style_dark .sc_button_simple:not(.sc_button_bg_image):before {
    background-color: {$colors['text_hover']};
}
.sc_services_callouts.color_style_dark .sc_button_simple:not(.sc_button_bg_image):after {
    border-left-color: {$colors['text_hover']};
}
.sc_services_callouts.color_style_dark .sc_button_simple:not(.sc_button_bg_image):hover:before {
    background-color: {$colors['bg_color']};
}
.sc_services_callouts.color_style_dark .sc_button_simple:not(.sc_button_bg_image):hover:after {
...
.widget_area.sc_widget_aboutme .widget_aboutme {
    border-color: {$colors['bd_color']};
}
.sc_recent_news_title {
    color: {$colors['text_link']};
}
.sc_recent_news_header_split .sc_recent_news_header_categories .sc_recent_news_header_category_item {
    color: {$colors['text']};
}
.sc_recent_news_header_split .sc_recent_news_header_categories .sc_recent_news_header_category_item:hover {
    color: {$colors['text_dark']};
}
.sc_recent_news.sc_recent_news_style_news-excerpt .post_item .post_featured .post_info .post_categories a,
.sc_recent_news.sc_recent_news_style_news-magazine .post_item .post_info .post_categories a {
    color: {$colors['bg_color']};
    background-color: {$colors['text_hover']};
}
.sc_recent_news.sc_recent_news_style_news-excerpt .post_item .post_featured .post_info .post_categories a:hover,
.sc_recent_news.sc_recent_news_style_news-magazine .post_item .post_info .post_categories a:hover {
    color: {$colors['bg_color']};
    background-color: {$colors['text_link']};
}
.trx_addons_widget_title {
