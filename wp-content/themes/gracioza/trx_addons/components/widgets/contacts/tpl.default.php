	...
	if (!empty($address) || !empty($phone) || !empty($email)) {
		?><div class="contacts_info"><?php
			if (!empty($address)) {
                ...
                ?><span class="contacts_label"><?php esc_html_e('Address','gracioza');?></span><span class="contacts_address"><?php echo str_replace('|', "<br>", $address); ?></span><?php
				if ($columns) {
					?></div><?php
				}
			}
			if (!empty($phone) || !empty($email)) {
				...
				if (!empty($email)) {
					?><span class="contacts_label"><?php esc_html_e('Email','gracioza');?></span><span class="contacts_email"><a href="mailto:<?php echo antispambot($email); ?>"><?php echo antispambot($email); ?></a></span><?php
				}
				if (!empty($phone)) {
					?><span class="contacts_label"><?php esc_html_e('Phone','gracioza');?></span><a href="<?php echo esc_attr(trx_addons_get_phone_link($phone)); ?>" class="contacts_phone"><?php echo wp_kses_data($phone); ?></a><?php
				}
				if ($columns) {
					?></div><?php
				}
