...
$nitropack_functions_file = 'C:\wamp64\www\newscleanlife\wp-content\plugins\nitropack\functions.php';
$nitropack_abspath = 'C:\wamp64\www\newscleanlife/';
...
if (file_exists($nitropack_functions_file) && ABSPATH == $nitropack_abspath) {
    ...
    define( 'NITROPACK_ADVANCED_CACHE_VERSION', '1.5.11');
    define( 'NITROPACK_LOGGED_IN_COOKIE', 'wordpress_logged_in_ccef5234e5e4f2dd3faeea044df47907' );
